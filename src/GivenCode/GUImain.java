...
public class GUImain {
	...
	private GUImain() {
		...
		obstacleCreationProb = new LabelledTextArea("GivenCode.Obstacle: ", defSimProb);
		vehicleCreationProb = new LabelledTextArea("GivenCode.Vehicle: ", defSimProb);
		...
		rockClusterStd = new LabelledTextArea("GivenCode.Rock Clusters Std: ", defRockClusterStd);
		...
		rockBox.setBorder(new TitledBorder("GivenCode.Rock Placement"));
	...
	private void setUp() {
		try{
			...
			// Set the values in the GivenCode.ModelConstants class
