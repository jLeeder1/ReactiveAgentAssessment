...
public class Simulator
{
    ...
    //private ArrayList<GivenCode.Obstacle> obstacles;
    ...
    public Simulator(int depth, int width)
    {
        ...
        //obstacles = new ArrayList<GivenCode.Obstacle>();
    ...
    public void simulateOneStep()
    {
       ...
       for(Iterator<Vehicle> it = vehicles.iterator(); it.hasNext(); ) {
           ...
           System.out.println("GivenCode.Vehicle location:" + v.getLocation().toString());
       }
            	...
            	if(field.getObjectAt(location)==null)
            	{
	                ...
	                if(ran <= obsProb) {
	                    ...
	                    //obstacles.add(o);
	                   	...
	                   	//location = new GivenCode.Location(20, 20);
